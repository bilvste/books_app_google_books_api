BookModel bookModelFromJson(str) => BookModel.fromJson(str);
...
enum AccessViewStatus { FULL_PUBLIC_DOMAIN, SAMPLE }
...
enum Viewability { ALL_PAGES, PARTIAL }
...
enum Saleability { FOR_SALE, FREE, NOT_FOR_SALE }
    ...
    industryIdentifiers: json["industryIdentifiers"] == null
        ...
        : List<IndustryIdentifier>.from(
            json["industryIdentifiers"].map(
              (x) => IndustryIdentifier.fromJson(x),
            ),
          ),
